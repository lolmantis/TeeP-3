...
public final class WalkerConsts {
	...
	public static final File purr = new File("CatPurringSoundEffectLoud.wav");
	public static final File meow = new File("MeowSoundEffectLoud.wav");
